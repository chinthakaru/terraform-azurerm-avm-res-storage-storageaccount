resource "azurerm_storage_queue" "this" {
  ...
  depends_on = [azapi_resource.containers, time_sleep.wait_for_rbac_before_queue_operations, azurerm_storage_account.this, azurerm_storage_account_network_rules.this]
}
